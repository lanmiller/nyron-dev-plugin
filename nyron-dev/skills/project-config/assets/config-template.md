...
merge_rights: dispatcher     # кто сливает в main и пушит: dispatcher (дефолт) |
                             # lead | cto — в некоторых командах право мержа
                             # только у человека; волна не мержит при любом значении
