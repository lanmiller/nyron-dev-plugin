...
| `feature-intake` | «надо добавить такой функционал» | рамка бизнес-требования (мандат, не ставка): файл-требование → согласование → эпик + нарезка задач; тикеты заводит груминг |
